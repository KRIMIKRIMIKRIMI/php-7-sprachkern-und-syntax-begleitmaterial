...
<body>
    <p>
        ...
        dieser hat den Datentyp <?php echo ucfirst($datentypTest1); ?>!
    </p>
    <p>
        Der Wert der Variable ist <?php echo $test2; ?> und
        dieser hat den Datentyp <?php echo ucfirst($datentypTest2); ?>!
    </p>
    <p>
        Der Wert der Variable ist <?php echo $test3; ?> und
        dieser hat den Datentyp <?php echo ucfirst($datentypTest3); ?>!
    </p>
</body>
